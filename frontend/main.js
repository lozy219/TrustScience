...
$.get('frontend/data/nickname.json?_v=yuzaohou')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=yuzaohou')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=yuzaohou')
      .done(scores => {
        $.get('frontend/data/data.json?_v=yuzaohou')
          .done(content => {

...
$.get('frontend/data/nickname.json?_v=liujianqiao')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=liujianqiao')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=liujianqiao')
      .done(scores => {
        $.get('frontend/data/data.json?_v=liujianqiao')
          .done(content => {

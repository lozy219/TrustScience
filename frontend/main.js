...
$.get('frontend/data/nickname.json?_v=yuzaoqian')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=yuzaoqian')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=yuzaoqian')
      .done(scores => {
        $.get('frontend/data/data.json?_v=yuzaoqian')
          .done(content => {

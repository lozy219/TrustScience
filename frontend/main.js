...
$.get('frontend/data/nickname.json?_v=lianyou')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=lianyou')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=lianyou')
      .done(scores => {
        $.get('frontend/data/data.json?_v=lianyou')
          .done(content => {

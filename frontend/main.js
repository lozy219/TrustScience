...
$.get('frontend/data/nickname.json?_v=chiyanyaodaoji')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=chiyanyaodaoji')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=chiyanyaodaoji')
      .done(scores => {
        $.get('frontend/data/data.json?_v=chiyanyaodaoji')
          .done(content => {

...
$.get('frontend/data/nickname.json?_v=yuzaozhong')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=yuzaozhong')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=yuzaozhong')
      .done(scores => {
        $.get('frontend/data/data.json?_v=yuzaozhong')
          .done(content => {

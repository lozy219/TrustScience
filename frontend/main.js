...
$.get('frontend/data/nickname.json?_v=tongge')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=tongge')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=tongge')
      .done(scores => {
        $.get('frontend/data/data.json?_v=tongge')
          .done(content => {

...
$.get('frontend/data/nickname.json?_v=baizangzhu')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=baizangzhu')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=baizangzhu')
      .done(scores => {
        $.get('frontend/data/data.json?_v=baizangzhu')
          .done(content => {

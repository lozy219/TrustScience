...
$.get('frontend/data/nickname.json?_v=shantong')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=shantong')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=shantong')
      .done(scores => {
        $.get('frontend/data/data.json?_v=shantong')
          .done(content => {

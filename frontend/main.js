...
$.get('frontend/data/nickname.json?_v=baqidashe')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=baqidashe')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=baqidashe')
      .done(scores => {
        $.get('frontend/data/data.json?_v=baqidashe')
          .done(content => {

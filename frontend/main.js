...
$.get('frontend/data/nickname.json?_v=yanmo')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=yanmo')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=yanmo')
      .done(scores => {
        $.get('frontend/data/data.json?_v=yanmo')
          .done(content => {

...
$.get('frontend/data/nickname.json?_v=sanweihu')
  .done(data => {
...
$.get('frontend/data/filename.json?_v=sanweihu')
  .done(data => {
    filenames = data;
    $.get('frontend/data/weightedScore.json?_v=sanweihu')
      .done(scores => {
        $.get('frontend/data/data.json?_v=sanweihu')
          .done(content => {
